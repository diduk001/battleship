...
class UI:
    ...
    def add(self, cords: tuple[int, int], size: tuple[int, int], obj) -> None:
        ...
        self.objs.append((cords, size, obj))

    def render(self, screen: pygame.Surface) -> None:
        for cords, size, obj, in self.objs:
    ...
    def click(self, click_cords: tuple[int, int]) -> None:
        ...
        for obj_cords, obj_size, obj in self.objs:
